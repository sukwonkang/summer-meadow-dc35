...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/summer-meadow-dc35
```

A live public deployment of this template is available at [https://summer-meadow-dc35.templates.workers.dev](https://summer-meadow-dc35.templates.workers.dev)
